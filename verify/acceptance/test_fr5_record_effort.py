...
from verify.acceptance.conftest import assert_201, assert_409, assert_404, assert_422
...
def test_record_effort_success(client):
    ...
    body = assert_201(client.post("/segment-efforts", json={
...
def test_record_effort_duplicate_409(client):
    ...
    assert_409(client.post("/segment-efforts", json={
        "activity_id": activity_id,
        "segment_id": segment_id,
        "user_id": user["user_id"],
        "elapsed_time": 320,
...
def test_record_effort_nonexistent_activity_404(client):
    ...
    assert_404(client.post("/segment-efforts", json={
...
def test_record_effort_missing_required_422(client):
    ...
    assert_422(client.post("/segment-efforts", json={
        "activity_id": activity_id,
        "segment_id": segment_id,
        "user_id": user["user_id"],
    }))
